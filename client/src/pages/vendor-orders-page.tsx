...
import { Calendar, DollarSign, Package, TrendingUp, X, Edit, Trash2, FileText, Filter } from "lucide-react";
    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-extrabold text-foreground mb-1">Vendor Orders</h1>
            <p className="text-lg text-muted-foreground font-medium">Manage your product orders and track profits</p>
          </div>
          <Button
            variant="ghost"
            size="icon"
